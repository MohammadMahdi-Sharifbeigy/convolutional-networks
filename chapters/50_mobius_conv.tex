...
\paragraph{کانولوشن‌های \textit{\lr{GM}}:}
...
\begin{table}
	...
	\caption[]{\small
		...
		پنج \lr{CNN} مستقل از جهت‌گیری در چندگانگی‌های $(m_{\textup{\lr{triv}}},m_{\textup{\lr{sign}}},m_{\textup{\lr{reg}}})$ انواع میدان متفاوت هستند اما دقیقاً در تعداد کانال‌ها و تقریباً در تعداد پارامترها موافق هستند.
...
تنها مدلی که کاملاً بر میدان‌های \lr{sign-flip} مبتنی است بدتر عمل می‌کند ـ این نشان می‌دهد که ترکیب استفاده شده از میدان‌های \lr{sign-flip} و غیرخطی‌ها انتخاب خوبی نیست، علی‌رغم اینکه مستقل از مختصات است.
...
تفسیر ما از این نتیجه این است که قیدهای کرنل شامل میدان‌های ویژگی منتظم اساساً اجازه کانال‌های کرنل بدون قید را می‌دهند، با شرط اضافی اعمال دو کپی بازتاب یافته از آنها ـ این را در تضاد با کرنل‌های $\Flip$-راهبری‌پذیر بین میدان‌های \lr{irrep} ببینید که باید \emph{درون} یک کانال کرنل متقارن باشند.
