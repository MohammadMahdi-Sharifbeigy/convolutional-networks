...
ایزومورفیسم $C^\infty(\GM) \cong \Gamma(\A_{\textup{\lr{reg}}})$ ادعای ما را در بخش~\ref{sec:instantiations_mesh} مبنی بر اینکه \emph{\lr{CNN}های چارچوب موازی} توسط یانگ و همکاران~\cite{Yang2020parallelFrameCNN} کانولوشن‌های $\GM$ خاصی بین میدان‌های ویژگی منظم هستند، اثبات می‌کند.
