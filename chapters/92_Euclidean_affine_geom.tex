...
در اصل می‌توان هر $G$-ساختاری را در نظر گرفت، با این حال، ما به طور خاص به آن $G$-ساختارهایی علاقه‌مندیم که \lr{CNN}های راهبری‌پذیر کلاسیک را از بخش قبل بازیابی می‌کنند، که تمام مدل‌های ردیف‌های (۱-۲۶) جدول~\ref{tab:network_instantiations} را توضیح می‌ده\lr{ają}.
...
\begin{figure}
	...
	\caption{\small
		...
		{\\
			...
			\lr{Creative Commons Attribution 4.0} 
...
\subsubsection{\textit{\lr{G}}-اطلس‌ها و \textit{\lr{G}}-ساختارهای القا شده}
...
\begin{thm}[ایزومورفیسم کلاف اصلی بین \lr{Aff(G)} و \textit{\lr{GM}}]
...
\begin{dfn}[تبدیلات آفین حافظ \textit{\lr{G}}-ساختار]
	\label{dfn:AffGM}
...
\begin{thm}[$\AffGM$ در بدیهی سازی های محلی]
