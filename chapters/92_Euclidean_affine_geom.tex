...
\subsubsection{چارت‌های افاین و اطلس‌های \lr{Aff(G)}}
...
همانند مورد ایزومتری‌ها، ما زیرگروه‌های $\AffGM \leq \AffE$ از تبدیلات افاین حافظ $G$-ساختار را تعریف می‌کنیم:
\begin{dfn}[تبدیلات افاین حافظ \textit{G}-ساختار]
	\label{dfn:AffGM}
...
\begin{thm}[$\AffGM$ در چارت‌های افاین سراسری]
