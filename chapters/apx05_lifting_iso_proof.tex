...
\paragraph{بخش ۱) ـ ساخت \textit{\lr{H}}, \textit{\lr{HM}} و \lr{Isom}\textsubscript{\textit{\lr{HM}}}:}
...
\paragraph{بخش ۲) -- هم‌ارزی تبدیلات میدان کرنل $\I$-هموردا و کانولوشن‌های \textit{\lr{HM}}:}
