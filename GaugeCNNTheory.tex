...
% Load hyperref last (after xepersian)
\usepackage[unicode]{hyperref}

% Load xepersian early to avoid conflicts
\usepackage{xepersian}
\settextfont{B Zar} % Changed from BYas to avoid italic issues
\setdigitfont{B Zar}
...
% Title and author - Fixed structure
\title{شبکه‌های کانولوشنی مستقل از مختصات}
\author{%
	شبکه‌های کانولوشنی مستقل از مختصات \\[0.5ex]
	کانولوشن‌های یکسان نسبت به ایزومتری و پیمانه روی منیفلدهای ریمانی \\[2ex]
	موریس وایلر، پاتریک فوره، اریک ورلینده، مکس ولینگ \\
	دانشگاه آمستردام
}
...
\begin{document}
	...
	% Author details in a separate section
	\begin{center}
		\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
			موریس وایلر & پاتریک فوره \\
			دانشگاه آمستردام & دانشگاه آمستردام \\
			\texttt{m.weiler.ml@gmail.com} & \texttt{p.d.forre@uva.nl} \\[2ex]
			اریک ورلینده & مکس ولینگ \\
			دانشگاه آمستردام & دانشگاه آمستردام، \\
			& پژوهشگاه هوش مصنوعی کوالکام \\
